                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        ...
                        @endif
                            ...
                            {{ csrf_field() }}
                            <!-- 注意这里多了 @change -->
                            <!--由于 Html 里的标签和属性不区分大小写，因此我们不能用 :initValue="xxxx" 来给组件传属性，这样传到 Vue 里就变成了 initvalue=xxx。
                            而 Vue 有个特性则是把 Html 属性名称里的 -{小写字母} 变成大写字母，也就是 Html 属性 init-value 对应 Vue 里的 initValue 属性。-->
